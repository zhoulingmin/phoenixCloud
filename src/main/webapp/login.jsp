...
<body>
 <div class="login_main">
   <div class="login">
    ...
    <div class="line">
      <a href="javascript:void(0)"><img src="<%=ctx %>/image/login_icon1.jpg" class="icon"> <input type="password" id="password" name="staff.password" class="line_txt" placeholder="密码"></a><span><a href="#">忘记密码</a></span>
     </div>
     <div class="line margin_top_20">
     <img src="<%=ctx %>/image/login_btn.jpg" onclick="login();">&nbsp;&nbsp;<img src="<%=ctx %>/image/exit_btn.jpg" onclick="self.close();">
     </div>
     </form>
     <div class="line_tips">江苏凤凰数字传媒有限公司 荣誉出品<br>
        江苏凤凰数字传媒有限公司 研发</div>
