			...
			<div class="widget-content nopadding">
				<form id="addStaffPur" class="form-horizontal" method="POST" action="#">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="staffPur.staffId">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="staffPur.purviewId">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="staffPur.cfgStaffId">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="staffPur.notes">
						</div>
					</div>
