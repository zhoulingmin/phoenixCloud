...
<body>
	...
	<div class="right_main">
		<div class="head">
			<img src="<%=ctx %>/image/home_icon.jpg">&nbsp;系统日志管理&gt;日志详情
		</div>
		...
		<div class="widget-box">
			...
			<div class="widget-content">
			    <div class="line_info margin_top_5">
					...
					<font color="black"><s:property value="booklog[0]"/></font>
				</div>
				<div class="line_info margin_top_5">
					<font class="blue">操作书籍: </font>
					<font color="black">《<s:property value="booklog[1]"/>》</font>
				</div>
				<div class="line_info margin_top_5">
					<font class="blue">操作类型: </font>
					<font color="black"><s:property value="booklog[3]"/></font>
				</div>
				<div class="line_info margin_top_5">
					<font class="blue">操作方法: </font>
					<font color="black"><s:property value="booklog[4]"/></font>
				</div>
				<div class="line_info margin_top_5">
					<font class="blue">操作用户: </font>
					<font color="black"><s:property value="booklog[2]"/></font>
				</div>
				<div class="line_info margin_top_5">
					<font class="blue">操作内容: </font>
					<font color="black"><s:property value="booklog[7]"/></font>
				</div>
				<div class="line_info margin_top_5">
					<font class="blue">操作时间: </font>
					<font color="black"><s:property value="booklog[5]"/></font>
				</div>
				<div class="line_info margin_top_5">
					<font class="blue">操作地址: </font>
					<font color="black"><s:property value="booklog[6]"/></font>
				</div>
				<div class="line_info margin_top_5">
