	...
	<div class="right_main">
		...
		<div class="widget-content">
			...
			<div class="widget-box" >
				<div class="widget-content">
					<input class="btn btn-primary" type="button" onclick="batchGenRegCode()" value="批量添加">
					&nbsp;<input id="codeNum" type="text" value="5" style="width: 30px; padding-bottom: 4px; margin-bottom: 0px;">
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input class="btn btn-primary" type="button" onclick="queryRegCode()" value="查询">
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input class="btn btn-primary" type="button" onclick="batchDelRegCode()" value="批量删除">
				</div>
			</div>
...
function searchBook() {
	jQuery.ajax({
		...
		success: function(bookArr) {
			...
			if (bookArr.length == 0) {
				jQuery("#bookTblBody").append("<tr><td colspan=\"9\">请先搜索书籍！</td></tr>");
			}
		},
		error: function(XMLReq, txt) {
			if(txt != null) {
